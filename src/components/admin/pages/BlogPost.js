...
import TableBlog from '../Global/TableBlog';
  ...
  return (
   ...
   <Grid container>
          ...
          <Grid item container justifyContent="space-between" alignItems="center" mt="15px">
           <Grid item>
              <Button id="addnewuser_btnText" startIcon={<ArrowCircleRightOutlinedIcon/>} sx={{fontWeight:500,fontSize:"20px",color:"#212529",textTransform:"unset"}}>Posts</Button>
             <Button id="addnewuser_btnText2" sx={{fontWeight:500,fontSize:"20px",color:"#212529",textTransform:"unset"}}>Posts</Button>
           </Grid>
          </Grid>
    ...
    <Grid item xs={12} lg={12} md={12} sm={12}>
          <TableBlog dummyData={blogData} rows={rows} setRows={setRows}/>
    </Grid>
      </Grid>
    </Paper>
              </Grid>
